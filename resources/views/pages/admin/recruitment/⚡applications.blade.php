...
<div class="max-w-5xl mx-auto space-y-8">
    <div class="flex items-center justify-between">
        <div>
            <flux:link :href="route('admin.recruitment.index')" icon="chevron-left" variant="ghost" class="mb-4">Retour aux offres</flux:link>
    ...
    <div class="space-y-4">
        @foreach ([
            ...
            <flux:card class="p-4 hover:border-emerald-500/50 transition-colors cursor-pointer group"
                onclick="window.location.href='/admin/recruitment/1/applications/{{ $candidate['id'] }}'">
