...
new #[Title('Mes Offres d\'Emploi')] class extends Component {
    ...
    <div class="flex flex-col gap-6">
        <div class="flex items-center justify-between">
            ...
            <flux:button :href="route('admin.recruitment.create')" variant="primary" icon="plus" wire:navigate>
                Créer une offre
            </flux:button>
        </div>
            ...
            @forelse ($this->offers() as $offer)
                <flux:card class="flex items-center justify-between p-4">
                    ...
                    <div class="flex items-center gap-2">
                        <flux:button :href="route('admin.recruitment.applications', $offer)" variant="ghost" size="sm" icon="users" wire:navigate>
                            Candidatures
                        </flux:button>
                        <flux:button :href="route('admin.recruitment.edit', $offer)" variant="ghost" size="sm" icon="pencil-square" wire:navigate />
                    </div>
                </flux:card>
            @empty
                <flux:card>
                    <div class="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <flux:button :href="route('admin.recruitment.create')" variant="primary" wire:navigate>Créer une offre</flux:button>
                    </div>
                </flux:card>
            @endforelse
        </div>
