    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
        <form class="space-y-6">
            ...
            <div class="flex gap-3 pt-6 border-t border-gray-200">
                <a href="{{ route('recruiter.offers.index') }}" class="flex-1 px-4 py-3 text-center rounded-xl border border-gray-200 text-gray-700 font-medium hover:bg-gray-50 transition">
                    Annuler
                </a>
