...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="font-medium text-gray-900">Nouvelles offres correspondantes</p>
                        <p class="text-sm text-gray-600">Recevez une notification pour chaque nouvelle offre compatible</p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p class="font-medium text-gray-900">Mises à jour sur candidatures</p>
                        <p class="text-sm text-gray-600">Notifications sur l'état de vos candidatures</p>
                    </div>
                    <input type="checkbox" class="w-5 h-5 rounded border-gray-300 text-brand-500 cursor-pointer" checked>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">Préférences de candidature</h2>
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Score minimum de compatibilité</label>
                    <div class="flex items-center gap-3">
                        <input type="range" min="0" max="100" value="40" class="flex-1">
                        <span class="text-sm font-medium text-gray-900">40%</span>
                    </div>
                    <p class="text-xs text-gray-500 mt-1">Vous recevrez des notifications pour les offres avec un score ≥ 40%</p>
                </div>
            </div>
        </div>
