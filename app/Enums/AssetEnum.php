...
enum AssetEnum: string
{
    ...
    public function label(): string
    {
        return match($this) {
            ...
            // Technique
            self::MAITRISE_ERP           => 'Maîtrise ERP (SAP / Oracle / Odoo)',
